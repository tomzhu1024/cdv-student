...
function gotData(incomingData) {
    ...
    function drawViz() {
        ...
        const dataGroups = vizGroup.selectAll('.dataGroup').data(currentYearData, d => d.Country);

        // take care of entering elements
        const enteringElements = dataGroups.enter()
            .append('g')
        ...
        enteringElements
            ...
            .transition()
            .delay(500)
            .attr('transform', d => `translate(${xScale(d.fert)}, ${yScale(d.life)})`)
            .attr('opacity', 1);
        ...
        dataGroups.exit()
            ...
            .delay(500)
            .ease(d3.easeBounce)
            .attr('transform', `translate(${xScale(fertExtent[1])}, ${yScale(lifeExtent[1])})`)
            .attr('opacity', 0)
            .remove();
    }
